...
type StudentProgress = {
  id: number;
  name: string;
  level1: { mastered: number; total: number; competencies: CompetencyStatus[] };
  level2: { mastered: number; total: number; competencies: CompetencyStatus[] };
  level3: { mastered: number; total: number; competencies: CompetencyStatus[] };
};
            ...
            <div className="grid grid-cols-3 gap-8 relative">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-8 h-8 rounded-full ${getStatusBg(
                      currentStudent.level1.mastered === currentStudent.level1.total
                        ? "mastered"
                        : currentStudent.level1.mastered > 0
                        ? "in-progress"
                        : "not-mastered"
              ...
              <div className="space-y-4">
                  ...
                  <div
                    className={`w-8 h-8 rounded-full ${getStatusBg(
                      currentStudent.level2.mastered === currentStudent.level2.total
                        ? "mastered"
                        : currentStudent.level2.mastered > 0
                        ? "in-progress"
                        : "not-mastered"
                    )} flex items-center justify-center shadow-lg relative z-10`}
                  >
                ...
                <div className="bg-accent/5 border-2 border-accent/20 rounded-xl p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <span className="text-sm">Progress</span>
                    <span className="text-sm">
                      {currentStudent.level2.mastered}/{currentStudent.level2.total}
                  ...
                  <div
                    className={`w-8 h-8 rounded-full ${getStatusBg(
                      currentStudent.level3.mastered === currentStudent.level3.total
                        ? "mastered"
                        : currentStudent.level3.mastered > 0
                        ? "in-progress"
                        : "not-mastered"
                    )} flex items-center justify-center shadow-lg relative z-10`}
                  >
